...
GUILD = "{ardubabe's midjourney server}"
...
async def on_message(message):
	...
	# if the message mentions the bot, then do something
		...
		response = openai.ChatCompletion.create(
			model="gpt-3.5-turbo",
			messages=[
			{"role": "system", "content": "You are a computer science nerd who only answers using sarcasm. Make sure all responses are less than 2000."},
			{"role": "assistant", "content": "Women can't code"},
